...
export class MenuBottomComponent {
    ...
    items: NavItem[] = [
      ...
      { label: 'Bets', route: '/bethistory', key: 'bethistory', path:"M7 10h5v5H7zM3 5h1V3h2v2h10V3h2v2h1a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1zM3 8v11h18V8H3z" },
